...
public class TemplateTitle extends RelativeLayout {
    ...
    public void setBackImage(int  res){
        if (canBack){
            ImageView backBtn = (ImageView) findViewById(R.id.img_back);
            backBtn.setImageResource(res);
            ViewGroup.LayoutParams mLayoutParams = backBtn.getLayoutParams();
            mLayoutParams.height = 96;
            mLayoutParams.width =96;
            backBtn.setLayoutParams(mLayoutParams);
