        ...
        switch (e.getTipsType()){
            ...
            case Join:
                ...
                return stringBuilder +
                        App.getContext().getString(R.string.summary_group_mem_add);
            case Kick:
                return e.getUserList().get(0) +
                        App.getContext().getString(R.string.summary_group_mem_kick);
            case ModifyMemberInfo:
                ...
                return stringBuilder +
                        App.getContext().getString(R.string.summary_group_mem_modify);
            case Quit:
                return e.getOpUser() +
                        App.getContext().getString(R.string.summary_group_mem_quit);
