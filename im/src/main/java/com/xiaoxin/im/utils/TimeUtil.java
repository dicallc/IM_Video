...
public class TimeUtil {
    ...
    public static String getTimeStr(long timeStamp){
        ...
        if (calendar.before(inputTime)){
            ...
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy" + App.getContext().getResources().getString(
                R.string.time_year)+"MM"+App.getContext().getResources().getString(R.string.time_month)+"dd"+App.getContext().getResources().getString(R.string.time_day));
        ...
        if (calendar.before(inputTime)){
            ...
            if (calendar.before(inputTime)){
                SimpleDateFormat sdf = new SimpleDateFormat("M"+App.getContext().getResources().getString(R.string.time_month)+"d"+App.getContext().getResources().getString(R.string.time_day));
                return sdf.format(currenTimeZone);
            }else{
    ...
    public static String getChatTimeStr(long timeStamp){
        ...
        if (calendar.before(inputTime)){
            ...
            if (calendar.before(inputTime)){
                ...
                SimpleDateFormat sdf = new SimpleDateFormat("yyyy"+App.getContext().getResources().getString(R.string.time_year)+"MM"+App.getContext().getResources().getString(R.string.time_month)+"dd"+App.getContext().getResources().getString(R.string.time_day)+" HH:mm");
                return sdf.format(currenTimeZone);
            }
