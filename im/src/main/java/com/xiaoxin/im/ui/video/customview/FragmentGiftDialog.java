...
import com.xiaoxin.im.ui.video.adapter.GiftGridViewAdapter;
...
public class FragmentGiftDialog extends DialogFragment {
    ...
    private ArrayList<VIdeoIngGift> catogarys;
    ...
    private void initView(View rootView) {
        ...
        catogarys = new ArrayList<VIdeoIngGift>();
        for (int i = 0; i < catogary_names.length; i++) {
            VIdeoIngGift catogary = new VIdeoIngGift();
