package com.xiaoxin.im.ui.contact.send;
...
import com.xiaoxin.im.ui.customview.BeautyDialogFragment;
...
//                    mTXCameraRecord.setFilter(TCUtils.getFilterBitmap(getResources(), params.mFilterIdx));
    ...
    public void onRecordComplete(TXRecordCommon.TXRecordResult result) {
        ...
        if (mTXRecordResult.retCode != TXRecordCommon.RECORD_RESULT_OK) {
            ...
            intent.putExtra("videoPath", result.videoPath);
            intent.putExtra("coverPath", result.coverPath);
