package com.xiaoxin.im.ui.video.customview;
...
public class GiftItemView extends LinearLayout {
    ...
    private void init() {
        ...
        setLayoutParams(lp);
        View convertView = LayoutInflater.from(getContext()).inflate(R.layout.videoing_item_gift_message,null,false);
    ...
    public void setGift(VIdeoIngGift gift) {
        this.gift = gift;
        refreshView();
    }
    ...
    public void refreshView(){
        ...
        if (!TextUtils.isEmpty(gift.img)){
            Glide.with(getContext()).load(gift.img).placeholder(R.mipmap.default_head).into(avatar);
        }else {
            avatar.setImageResource(R.mipmap.default_head);
        }
    ...
    public interface OnAnimatorListener{
        public void onAnimationEnd(VIdeoIngGift gift);
        public void onAnimationStart(Animator animation);
    }
}
