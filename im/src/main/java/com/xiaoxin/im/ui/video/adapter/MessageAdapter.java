...
public class MessageAdapter extends BaseListAdapter<VIdeoIngMessage> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.videoing_item_message, null, false);
        ...
        VIdeoIngMessage message = datas.get(position);
